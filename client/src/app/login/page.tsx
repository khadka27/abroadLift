      ...
      <div className="flex-1 flex flex-col lg:flex-row relative">
        ...
        <div className="hidden lg:block lg:w-[50%] xl:w-[55%] relative overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 right-12 z-10 text-white drop-shadow-lg">
            <h2 className="text-4xl font-bold mb-4">Your Journey, Our Mission.</h2>
            <p className="text-lg opacity-80 max-w-md">Unlock access to over 6,000+ world-class programs across 7 countries. Start your global education today.</p>
          </div>
        </div>
