import { ArrowRight, ClipboardList, Gauge, PieChart, Navigation } from "lucide-react";
          ...
          <div className="flex flex-col">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
              {cards.map((card, idx) => (
                ...
                >
                  <div className="mb-4 text-[#3686FF]">
                    {card.icon}
                  </div>
            ...
            <div>
              <Button className="h-[50px] rounded-[10px] bg-[#3686FF] hover:bg-[#2563eb] text-white font-bold px-[28px] text-[15px] shadow-[0_8px_20px_rgb(54,134,255,0.25)] transition-all hover:scale-105 hover:shadow-lg">
                Join Our Network <ArrowRight className="w-4 h-4 ml-1.5" strokeWidth={2.5} />
              </Button>
            </div>
          </div>
